...
param(
 ...
 [string]
 $TemplateFilePath = "C:\NEWTemplates\Build\GENDEPLOYNETWORK.json",

 [string]
 $ParametersFilePath = "C:\NEWTemplates\Build\Param\GENPARAM.json"
)
...
if(Test-Path $ParametersFilePath) {
    New-AzResourceGroupDeployment -ResourceGroupName $ResourceGroupName -TemplateFile $TemplateFilePath -TemplateParameterFile $ParametersFilePath -Name armGENNETDeployment -Verbose;
} else {
    New-AzResourceGroupDeployment -ResourceGroupName $ResourceGroupName -TemplateFile $TemplateFilePath -Name armGENNETDeployment -Verbose;
}